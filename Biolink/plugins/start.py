...
If you need help or updates, check the buttons below 👇"""
        ...
        buttons = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("➕ Add me to your group", url="https://t.me/Bio_xremoverbot?startgroup=true")],
                [InlineKeyboardButton("📢 Updates Channel", url="https://t.me/ABOUT_ROLEX_ANU")],
                [InlineKeyboardButton("❓ Help & Commands", callback_data="help")]
            ]
        )

        photo_url = "https://postimg.cc/5H8P5Y7F"
